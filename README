...
Contact:
--------
    Bug reports and feature requests should be directed to the Google Code issue tracker:
    http://code.google.com/p/eqdkp/issues/list
...
--------
    ...
    Thanks:
        ...
        Blood of the Spider Guild [ www.botsguild.org ]
        Necessary Evil Guild [ www.wickedintentions.com ]
        Precision Strike Guild [ www.precisionstrike.com ]
