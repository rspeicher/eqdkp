...
for(var D in A){this.elements[C].setStyle(D,B[D].getValue(A[D],this.options.unit,D));}}}});var Asset=new Abstract({javascript:function(C,B){B=$merge({"onload":Class.empty},B);
